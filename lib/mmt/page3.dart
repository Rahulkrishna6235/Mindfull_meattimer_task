...
class _TimerPage3State extends State<TimerPage3> {
  double percent=0.0;
  late Timer timer;
  _startTimer(){
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Finish your meal",style: TextStyle(fontSize: 25,color: Colors.white),),
                Text("you can eat until you feel full",style: TextStyle(fontSize: 18,color: Colors.white60),),
                SizedBox(height: 16,),
                Stack(
                  children: [
                    Container(
