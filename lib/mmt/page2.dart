        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Break Time",style: TextStyle(fontSize: 25,color: Colors.white),),
                Text("Take a five-minute break to check in on your ",style: TextStyle(fontSize: 18,color: Colors.white60),),
                Text(" level of fullness",style: TextStyle(fontSize: 18,color: Colors.white60),),
